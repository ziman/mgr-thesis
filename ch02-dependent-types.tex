...
In order to introduce Agda syntax, as a brief crash-course illustrating how to
read code in the thesis, we will implement a very simple compiler for a
...
for example in \cite{epigram-compiler} (in Epigram) or \cite{chlipala:compiler}
(in Coq).
...
It is probably a reasonable requirement that our language should have
...
indicate what the type of the expression is -- and while we could use Agda
...
This approach lets us have all types flat in the lowest Agda type
