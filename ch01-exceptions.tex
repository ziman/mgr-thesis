...
To illustrate where this resemblance breaks, let us take an example: Peirce's law, which is
...
a well-typed term. Note that the $\alpha$ labeling the inner \ident{catch} is distinct
...
%\todo{\cite{kameyama:dynamic}.}

\subsection{Conclusion}

\todo{The theoretical appeal of studying exceptions in functional languages is the ability
to strengthen the logics corresponding under Curry-Howard.}
