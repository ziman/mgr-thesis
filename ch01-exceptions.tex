...
keywords designated for exceptions and use plain functions instead (Haskell), etc.

The variety is large but all of these languages share the main principles of exception handling,
...
a semantics, create a compiler and examine how this all works together in a dependently
