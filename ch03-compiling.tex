...
\begin{itemize}
	...
	\item in the third and fourth clause of the function \ident{execInstr},
		we push and pop only placeholders;
...
As already mentioned, we prove this correctness theorem by induction on the expression
\ident{e}

First lemma we will need, we need a distributivity lemma, again practically identical to that in
\Fref{sec:cor-compile-distr}.
\begin{code}
