...
Suddenly, recursion is naturally completely structural. In the following code,
we will use the auxiliary functions \ident{unwindStack}
(\Fref{sec:ham-unwindStack}) and \ident{unwindShape}
(\Fref{sec:ham-unwindShape}), trivially modified to work with the stack type we
are using here.
