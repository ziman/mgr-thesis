...
expressions in \Fref{sec:simple-compiler}. We keep all definitions: the
functions $[\!\![\_]\!\!]$ and \ident{opInstr}, and both cases of the function
\ident{compile} -- these will be extended with two new clauses for the expressions
\ident{Throw} and \ident{Catch}.
