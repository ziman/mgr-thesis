...
examine ways found in the literature.
...
copy the code as is; instead, we will adapt it for the dependently typed
setting and see how it works out.
...
\begin{code}
  ...
  data Exp : U -> Set where
    ...
    Catch : forall {u} -> (code : Exp u) -> (hnd : Exp u) -> Exp u
\end{code}
