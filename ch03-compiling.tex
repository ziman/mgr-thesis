...
these components:%
\footnote{For now, we will leave the position in the code implicit and we will not count
...
\todo{Not worse than GHM because they don't jump to addresses when looking for
