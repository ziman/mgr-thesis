...
Like in the placeholder method, we will push handlers on the stack, which contradicts
the principles we pursue and isn't really executable by real machines. We will address
this issue later, in Chapter \ref{chap:compiling2}.

For quitting the current handler frame, we need to skip all instructions left to execute
within the frame.
\\ \todo{Frame skipping as machine state. Termination. Measure.}
