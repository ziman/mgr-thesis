...
For example, in every catch-expression, there are actually two independent
paths the code may take.  Note that the \emph{guarded expression} is
...
However, while it looks promising and the transformation of

\todo{Structurality not the only option. Measure. Bove-Capretta.}

\subsubsection{Correctness}

\todo{Not proved in the attached Agda development: non-termination}

\subsubsection{Remarks}

\todo{List all insuffiencies of the placeholder approach and describe
what's better here and what's not.}
