...
\sectionfont{\centering\rm\itshape}
\subsectionfont{\rm}
\subsubsectionfont{\rm\bf}

\newcommand{\lrule}[2]{%
  \noindent\hbox{{\vrule width #1}\hskip 0.7em\vbox{\noindent #2}\hskip 0.7em{\vrule width #1}}%
}

\newcommand{\inset}[1]{\begin{wrapfigure}{r}{0.25\textwidth}%
\vspace{-1em}%
\lrule{0.5pt}{\footnotesize #1}%
\vspace{-1em}%
\end{wrapfigure}%
}
...
\newcommand{\todo}[1]{\noindent\parbox{0.94\textwidth}{\lrule{5pt}{\textsf{\textbf{TODO:}} #1}}%
\vspace{0.5em}}
