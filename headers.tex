...
\lstdefinestyle{agda}{
      ...
      escapechar=&,
      xleftmargin=9pt,
      morekeywords={data,where,open,import,let,with,module,using,infixr,rewrite,mutual,in,case,of,infix,infixl},
      literate=
      	{+}{{$+\;$}}1
      	{/}{{$/$}}1
      	{*}{{$*$}}1
...
\newcommand{\srcdir}[1]{The corresponding Agda code can be found in the attached development,
in the subdirectory \textsf{#1}.}
